...
public class CharacterController2D : MonoBehaviour
{
	...
	public bool isGrounded { get { return isReversed ? collisionState.above : collisionState.below; } }
	...
	public void move(Vector3 deltaMovement)
	{
		...
		if (isReversedInt * deltaMovement.y < 0f && collisionState.wasGroundedLastFrame)
	...
	public void warpToGrounded()
	{
		do
		{
			move(new Vector3(0, isReversedInt - 1f, 0));
		} while (!isGrounded);
	}
